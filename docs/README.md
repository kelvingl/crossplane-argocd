...
- [`compositions.md`](./compositions.md) — as duas Compositions (`dataplane-cluster`, `s3-bucket`): XRD/claim, o que cada uma compõe, empacotamento Helm e fluxo de Makefile.
- [`decisions.md`](./decisions.md) — log estilo ADR com as decisões técnicas reais do projeto (34 entradas), incluindo incidentes e reversões.
